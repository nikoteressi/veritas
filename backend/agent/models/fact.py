...
class FactHierarchy(BaseModel):
    ...
    primary_thesis: str = Field(
        description="The single, overarching claim or main point of the source. This summarizes the entire message."
    )
    supporting_facts: list[Fact] = Field(
        description="A list of atomic, verifiable facts that support the primary thesis."
    )
