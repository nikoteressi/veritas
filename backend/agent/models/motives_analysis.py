...
class MotivesAnalysisResult(BaseModel):
    ...
    confidence_score: float | None = Field(None, description="Confidence score (0.0-1.0)")
    credibility_assessment: str | None = Field(None, description="Credibility assessment (high/moderate/low)")
