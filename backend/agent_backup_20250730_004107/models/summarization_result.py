...
class SummarizationResult(BaseModel):
    ...
    sources_used: list[str] = Field(default_factory=list, description="Sources used for creating summary")
    key_points: list[str] = Field(default_factory=list, description="Key points highlighted in summary")
    temporal_context_included: bool = Field(
        default=False, description="Whether temporal context is included in summary"
    )
    fact_check_summary: str = Field(description="Brief summary of fact-checking results")
