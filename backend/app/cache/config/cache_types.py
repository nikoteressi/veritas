...
class CacheType(Enum):
    ...
    # Core cache types
    CHROMA_EMBEDDING = "chroma_embedding"  # ChromaDB-based embedding cache
...
class CacheTypes:
    ...
    # Core types
    CHROMA_EMBEDDING: Final[str] = CacheType.CHROMA_EMBEDDING.value
